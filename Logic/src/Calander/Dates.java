...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new Calander.Button();
        cmdTu = new Calander.Button();
        cmdWe = new Calander.Button();
        cmdTh = new Calander.Button();
        cmdFr = new Calander.Button();
        cmdSa = new Calander.Button();
        cmdSu = new Calander.Button();
        cmd1 = new Calander.Button();
        cmd2 = new Calander.Button();
        cmd3 = new Calander.Button();
        cmd4 = new Calander.Button();
        cmd5 = new Calander.Button();
        cmd6 = new Calander.Button();
        cmd7 = new Calander.Button();
        cmd8 = new Calander.Button();
        cmd9 = new Calander.Button();
        cmd10 = new Calander.Button();
        cmd11 = new Calander.Button();
        cmd12 = new Calander.Button();
        cmd13 = new Calander.Button();
        cmd14 = new Calander.Button();
        cmd15 = new Calander.Button();
        cmd16 = new Calander.Button();
        cmd17 = new Calander.Button();
        cmd18 = new Calander.Button();
        cmd19 = new Calander.Button();
        cmd20 = new Calander.Button();
        cmd21 = new Calander.Button();
        cmd22 = new Calander.Button();
        cmd23 = new Calander.Button();
        cmd24 = new Calander.Button();
        cmd25 = new Calander.Button();
        cmd26 = new Calander.Button();
        cmd27 = new Calander.Button();
        cmd28 = new Calander.Button();
        cmd29 = new Calander.Button();
        cmd30 = new Calander.Button();
        cmd31 = new Calander.Button();
        cmd32 = new Calander.Button();
        cmd33 = new Calander.Button();
        cmd34 = new Calander.Button();
        cmd35 = new Calander.Button();
        cmd36 = new Calander.Button();
        cmd37 = new Calander.Button();
        cmd38 = new Calander.Button();
        cmd39 = new Calander.Button();
        cmd40 = new Calander.Button();
        cmd41 = new Calander.Button();
        cmd42 = new Calander.Button();
        ...
        cmdSu.setForeground(new java.awt.Color(118, 118, 118));
        cmdSu.setText("Su");
        add(cmdSu);
    ...
    private Calander.Button cmd1;
    private Calander.Button cmd10;
    private Calander.Button cmd11;
    private Calander.Button cmd12;
    private Calander.Button cmd13;
    private Calander.Button cmd14;
    private Calander.Button cmd15;
    private Calander.Button cmd16;
    private Calander.Button cmd17;
    private Calander.Button cmd18;
    private Calander.Button cmd19;
    private Calander.Button cmd2;
    private Calander.Button cmd20;
    private Calander.Button cmd21;
    private Calander.Button cmd22;
    private Calander.Button cmd23;
    private Calander.Button cmd24;
    private Calander.Button cmd25;
    private Calander.Button cmd26;
    private Calander.Button cmd27;
    private Calander.Button cmd28;
    private Calander.Button cmd29;
    private Calander.Button cmd3;
    private Calander.Button cmd30;
    private Calander.Button cmd31;
    private Calander.Button cmd32;
    private Calander.Button cmd33;
    private Calander.Button cmd34;
    private Calander.Button cmd35;
    private Calander.Button cmd36;
    private Calander.Button cmd37;
    private Calander.Button cmd38;
    private Calander.Button cmd39;
    private Calander.Button cmd4;
    private Calander.Button cmd40;
    private Calander.Button cmd41;
    private Calander.Button cmd42;
    private Calander.Button cmd5;
    private Calander.Button cmd6;
    private Calander.Button cmd7;
    private Calander.Button cmd8;
    private Calander.Button cmd9;
    private Calander.Button cmdFr;
    private Calander.Button cmdMo;
    private Calander.Button cmdSa;
    private Calander.Button cmdSu;
    private Calander.Button cmdTh;
    private Calander.Button cmdTu;
    private Calander.Button cmdWe;
