...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new Calander.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new Calander.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new Calander.Button();
        cmdPrevious = new Calander.Button();
        slide = new Calander.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calander/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calander/previous.png"))); // NOI18N
    ...
    private Calander.Button cmdForward;
    private Calander.Button cmdMonth;
    private Calander.Button cmdPrevious;
    private Calander.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private Calander.Slider slide;
