 ...
 * Provides a form for entering employee information and an "Add" button to add the employee.
 * Extends javax.swing.JPanel.
 */
public class AddEmployeePnl extends javax.swing.JPanel {

    /**
     * Message object for displaying notifications.
     */
    Message obj = new Message();
  /**
     * Constructs a new AddEmployeePnl.
     * Initializes the components of the panel and sets up an event listener for the "OK" button in the notification message.
     */
...
/**
     ...
     * It validates the input data, creates a new employee object, adds it to the GymSystem's list of employees,
     * and displays a notification message. It also clears the input fields and writes the employee data to a file.
     *
